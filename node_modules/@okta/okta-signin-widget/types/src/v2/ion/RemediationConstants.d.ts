...
export const ORG_PASSWORD_RECOVERY_LINK: "currentAuthenticator-recover";
export namespace FORMS {
    ...
    const CHALLENGE_WEBAUTHN_AUTOFILLUI_AUTHENTICATOR: string;
    ...
    const REENROLL_CUSTOM_PASSWORD_EXPIRY: string;
    const REENROLL_CUSTOM_PASSWORD_EXPIRY_WARNING: string;
    ...
    const REDIRECT_IDVERIFY: string;
    ...
    const LAUNCH_WEBAUTHN_AUTHENTICATOR: string;
    const ENROLL_WEBAUTHN_RESIDENTKEY: string;
    const DEVICE_ENROLLMENT_TERMINAL: string;
    const USER_CODE: string;
    const KEEP_ME_SIGNED_IN: string;
    const DEVICE_ASSURANCE_GRACE_PERIOD: string;
...
export namespace ID_PROOFING_TYPE {
    const IDV_PERSONA: string;
    const IDV_CLEAR: string;
    const IDV_INCODE: string;
    const IDV_STANDARD: string;
}
