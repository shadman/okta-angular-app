...
const isCustomizedI18nKey = (i18nKey, settings) => {
  var _settings$get;
  const widgetLanguageLowerCase = (_settings$get = settings.get('languageCode')) === null || _settings$get === void 0 ? void 0 : _settings$get.toLowerCase();
  ...
  return Object.entries(i18n).some(([customizedLangCode, customizedI18nKeys]) => customizedLangCode.toLowerCase() === widgetLanguageLowerCase && !!customizedI18nKeys[i18nKey]);
};
