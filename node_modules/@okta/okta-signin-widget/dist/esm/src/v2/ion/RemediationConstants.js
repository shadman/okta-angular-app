...
const FORMS_WITHOUT_SIGNOUT = [FORMS.IDENTIFY, FORMS.SUCCESS_REDIRECT, FORMS.ENROLL_PROFILE, FORMS.DEVICE_ENROLLMENT_TERMINAL, FORMS.CONSENT_ADMIN, FORMS.CONSENT_ENDUSER, FORMS.CONSENT_GRANULAR, FORMS.CONSENT_EMAIL_CHALLENGE, FORMS.USER_CODE, FORMS.KEEP_ME_SIGNED_IN];
...
export { ACTIONS, ATTR_FORMAT, AUTHENTICATOR_KEY, AUTHENTICATOR_METHODS, FORMS, FORMS_FOR_VERIFICATION, FORMS_WITHOUT_SIGNOUT, FORMS_WITH_STATIC_BACK_LINK, FORM_NAME_TO_OPERATION_MAP, HINTS, IDP_FORM_TYPE, ID_PROOFING_TYPE, INTERSTITIAL_REDIRECT_VIEW, ORG_PASSWORD_RECOVERY_LINK, TERMINAL_FORMS };
